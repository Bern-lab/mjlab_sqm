"""LSTM Teacher-KL Unitree G1 blind-rough velocity environment configuration."""
...
def _lstm_teacherkl_play_terrain_cfg():
  # Match the Teacher-KL blind-rough play terrain.
...
def unitree_g1_blind_rough_lstm_teacherkl_env_cfg(
  ...
  """Create a blind-rough LSTM student env with frozen-teacher observations.

  The teacher observation group is aligned to the 1D proprioceptive/privileged
  part of the target-heading depth teacher policy. Its input order is:
