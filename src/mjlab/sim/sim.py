...
class SimulationCfg:
  ...
  """Number of convex CCD contacts to allocate per world.

  CCD buffers are separate from the general contact buffer and can become large on
  massively parallel tasks. If None, MJWarp derives the value from nconmax."""
  njmax: int | None = None
  ...
  contact_sensor_maxmatch: int = 128
  use_cuda_graph: bool = True
  """Whether to capture CUDA graphs for simulation and sensing on CUDA devices."""
